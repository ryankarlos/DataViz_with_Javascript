...
function updatesankey(year, theme) {
		...
		d3.csv("cleaned.csv", function(error, data) {
		  ...
		  graph = {"nodes" : [], "links" : []};
		    ...
		    data.forEach(function (d) {
					if (d.Award_Date.slice(-4) == year && d.Amount_Awarded > 10000 && d.Theme == theme) {
						console.log(d.Award_Date.slice(-4))
